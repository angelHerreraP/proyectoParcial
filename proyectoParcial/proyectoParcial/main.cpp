...
int main()
{
    ...
    int numFigura, numUnidades, contra, x, y, z;
    ...
    if (contra==16730){
        ...
        cout << "Seleccione A. Calcular el numero mayor" << endl;
        cout << "Seleccione B. Calcular el numero menor" << endl;
        cout << "Seleccione C. Si el numero es Par o impar" << endl;
        cout << "Seleccione D. Calcular la Raíz cuadrada" << endl;
        cout << "Seleccione E. Calcular el Perímetro y área de figuras" << endl;
        cout << "Seleccione E. Conversión de unidades" << endl;
